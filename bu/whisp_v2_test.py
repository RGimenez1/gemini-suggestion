...
TTS_VOICE_SEED = "nova"  # Voice seed option
...
def speak(text_to_speak):
    ...
    try:
        ...
        response = openai_client.audio.speech.create(
            model=TTS_MODEL,
            voice_seed=TTS_VOICE_SEED,  # Using voice_seed instead of voice
            input=text_to_speak,
            speed=TTS_SPEED,
...
try:
    ...
    speak("AI Music Assistant ready with the latest voice technology. How can I help create music today?")
